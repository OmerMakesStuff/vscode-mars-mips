...
const instructions: termInfo = {
  ...
  addiu:
    'Adds an immediate value to the value in $Rs, stores result in $Rt, unsigned',
  addu: '',
  and: '',
  ...
  multu:
    'Multiplies the values in $Rs and $Rt, storing the result in the HI and LO registers, unsigned',
  nor: '',
  or: '',
  ...
  rotrv:
    'Rotates the value in $Rt right by the value in $Rs logically, storing the result in $Rd',
  ...
  sltiu:
    'Sets $Rt to 1 if the value in $Rs is less than the immediate value, otherwise sets $Rt to 0, unsigned',
...
const pseudoInstructions: termInfo = {
  ...
  dbg_print_char:
    'Print the value of $Rs as a character without modifying any registers',
  dbg_print_int:
    'Print the value of $Rs as an integer without modifying any registers',
  dbg_print_str:
    'Print the value of $Rs as a string without modifying any registers',
